...
# load Mine data MAC
#grizzly.locations <- readOGR("/Volumes/BONE_1/Bucket_Data_TEST", "G175_2017")
#variable.data <- readOGR("/Volumes/BONE_1/Bucket_Data_TEST", "o05_Mines_Clipped")

grizzly.locations <- readOGR("/Volumes/BONE_1/Bucket_Data_TEST", "G175_2017")
variable.data <- readOGR("/Volumes/BONE_1/Bucket_Data_TEST", "o13_Wildfires_Clipped")
